...
public class Utils {
    ...
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(CQEVidaSpeechlet.class);
     ...
     * This method should be used only as a tempory solution to inaccurate slot values, the proper solution is to update the
