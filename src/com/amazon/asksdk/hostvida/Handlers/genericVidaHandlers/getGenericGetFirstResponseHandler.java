...
public class getGenericGetFirstResponseHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput handlerInput) {
        ...
        String requirementValue1 = "'Michael Connolly'"; //Note you must include ' ' in values if you are using a method as a key.
        ...
        else
        {
            try {
                ...
                if(Utils.retrieveServletErrors(handlerInput, jsonOutputString) == null)
                {
                    ...
                    return tellWithCard(handlerInput, "CIP Query","Count is equal to " + jsonOutput.getString("Output0") + " and first Quote Requests Name was " + jsonOutput.getString("Output1"));
                }
                else
                {
